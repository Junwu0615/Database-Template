...
with open('Database-Template_clone.json', 'r') as fh:
    now = json.load(fh)
with open('Database-Template_clone_before.json', 'r') as fh:
    before = json.load(fh)
...
with open('Database-Template_clone.json', 'w', encoding='utf-8') as fh:
